CREATE OR REPLACE PROCEDURE dodaj_rezerwacje3(id_wycieczki_param NUMBER, id_osoby_param NUMBER)
AS
    counter            INTEGER;
BEGIN
    SELECT COUNT(*)
    ...
    IF counter > 0 THEN
        raise_application_error(-20013, 'Rezerwacja z danym id wycieczki i id osoby juz istnieje');
    END IF;
