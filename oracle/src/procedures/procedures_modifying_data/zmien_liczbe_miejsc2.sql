CREATE OR REPLACE PROCEDURE zmien_liczbe_miejsc2(id_wycieczki_param NUMBER, liczba_nowych_miejsc_param NUMBER)
AS
    counter INTEGER;
BEGIN
    SELECT COUNT(*)
    ...
    SET LICZBA_MIEJSC = liczba_nowych_miejsc_param,
        LICZBA_WOLNYCH_MIEJSC = LICZBA_WOLNYCH_MIEJSC + (liczba_nowych_miejsc_param - LICZBA_MIEJSC)
